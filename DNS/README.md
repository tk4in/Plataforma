...
- Use o pendrive para instalar a ISO do [Alpine 3.23.4 kernel 6.18.34-0-lts](https://dl-cdn.alpinelinux.org/alpine/v3.23/releases/x86_64/alpine-standard-3.23.4-x86_64.iso).
