...
- Use o pendrive para instalar a ISO do [Alpine 3.24.1 kernel 6.18.34-0-lts](https://dl-cdn.alpinelinux.org/alpine/v3.24/releases/x86_64/alpine-standard-3.24.1-x86_64.iso).
